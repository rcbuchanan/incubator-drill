  ...
  public class WorkspaceSchema extends AbstractSchema {
    ...
    public Table getTable(String name) {
      ...
      if(tables.alreadyContainsKey(name)) {
        if (getMetadataTable(name) != null && tables.get(name).getDrillTableMetadata() == null) {
          tables.get(name).setDrillTableMetadata(new DrillTableMetadata(getMetadataTable(name), getMetadataTablePath(name)));
        } else {
