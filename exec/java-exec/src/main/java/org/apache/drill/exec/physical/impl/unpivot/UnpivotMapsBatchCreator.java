...
public class UnpivotMapsBatchCreator implements BatchCreator<UnpivotMaps>{
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(UnpivotMapsBatchCreator.class);

  @Override
  public RecordBatch getBatch(FragmentContext context, UnpivotMaps config, List<RecordBatch> children) throws ExecutionSetupException {
