...
public interface StatsUnpivotor {
  ...
  public static TemplateClassDefinition<StatsUnpivotor> TEMPLATE_DEFINITION = new TemplateClassDefinition<StatsUnpivotor>(StatsUnpivotor.class, UnpivotStatsTemplate.class);
